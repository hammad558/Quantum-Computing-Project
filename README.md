...
**Base Paper:** [https://arxiv.org/abs/2603.09789](https://arxiv.org/abs/2603.09789)
...
| Model | Type | Source |
|---|---|---|
| Baseline LSTM | Classical only | Base paper |
| LSTM-QCBM | Hybrid quantum-classical | Base paper |
| Baseline GRU | Classical only | **Our contribution** |
| GRU-QCBM | Hybrid quantum-classical | **Our contribution** |
...
|---|---|
| LSTM | 6.950 x 10⁻³ |
| LSTM-QCBM | 6.909 x 10⁻³ |
| GRU (ours) | **6.395 x 10⁻³** |
| GRU-QCBM (ours) | 6.468 x 10⁻³ |
...
|---|---|
| LSTM | 6.718 x 10⁻³ |
| LSTM-QCBM | 6.790 x 10⁻³ |
| GRU (ours) | 6.599 x 10⁻³ |
| GRU-QCBM (ours) | **6.207 x 10⁻³** |
...
| Dataset | omega | alpha | beta |
|---|---|---|---|
| S&P 500-like | 0.00001 | 0.10 | 0.85 |
| NASDAQ-like | 0.00001 | 0.12 | 0.83 |
...
1. Y. Chen, "A Hybrid Quantum-Classical Framework for Financial Volatility Forecasting Based on Quantum Circuit Born Machines," arXiv:2603.09789, 2026.
